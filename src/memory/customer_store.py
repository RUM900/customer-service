...
DEMO_ORDERS: list[Order] = [
    ...
    # --- 新增：覆盖全部状态 + 高金额订单（支持 HITL 场景） ---
    Order(
        order_id="ord_005",
        customer_id="cust_001",
        status=OrderStatus.DELIVERED,
        items=[{"name": "笔记本支架", "quantity": 1, "price": 199.00}],
        total_amount=199.00,
        currency="CNY",
        shipping_address="北京市朝阳区xxx路100号",
        tracking_number="SF2345678901",
        placed_at="2025-07-10T10:00:00",
        shipped_at="2025-07-11T09:00:00",
        delivered_at="2025-07-13T15:00:00",
    ),
    Order(
        order_id="ord_006",
        customer_id="cust_001",
        status=OrderStatus.SHIPPED,
        items=[{"name": "降噪耳机 Pro Max", "quantity": 1, "price": 1899.00}],
        total_amount=1899.00,
        currency="CNY",
        shipping_address="北京市朝阳区xxx路100号",
        tracking_number="JD3456789012",
        placed_at="2025-08-01T11:00:00",
        shipped_at="2025-08-02T10:00:00",
    ),
    Order(
        order_id="ord_007",
        customer_id="cust_001",
        status=OrderStatus.REFUNDED,
        items=[{"name": "雷蛇鼠标", "quantity": 1, "price": 450.00}],
        total_amount=450.00,
        currency="CNY",
        shipping_address="北京市朝阳区xxx路100号",
        tracking_number=None,
        placed_at="2025-05-20T09:30:00",
    ),
    Order(
        order_id="ord_008",
        customer_id="cust_002",
        status=OrderStatus.CANCELLED,
        items=[{"name": "扩展坞 USB-C", "quantity": 1, "price": 399.00}],
        total_amount=399.00,
        currency="CNY",
        shipping_address="上海市浦东新区xxx路200号",
        tracking_number=None,
        placed_at="2025-07-18T14:00:00",
    ),
    Order(
        order_id="ord_009",
        customer_id="cust_002",
        status=OrderStatus.RETURNED,
        items=[{"name": "无线充电器", "quantity": 1, "price": 129.00}],
        total_amount=129.00,
        currency="CNY",
        shipping_address="上海市浦东新区xxx路200号",
        tracking_number="YT9988776655",
        placed_at="2025-06-10T10:00:00",
        shipped_at="2025-06-11T09:00:00",
        delivered_at="2025-06-13T08:30:00",
    ),
    Order(
        order_id="ord_010",
        customer_id="cust_002",
        status=OrderStatus.PENDING,
        items=[{"name": "智能手表 S2", "quantity": 1, "price": 1499.00}],
        total_amount=1499.00,
        currency="CNY",
        shipping_address="上海市浦东新区xxx路200号",
        tracking_number=None,
        placed_at="2025-09-01T16:00:00",
    ),
    Order(
        order_id="ord_011",
        customer_id="cust_003",
        status=OrderStatus.CONFIRMED,
        items=[{"name": "数据线 2m", "quantity": 2, "price": 39.00}],
        total_amount=78.00,
        currency="CNY",
        shipping_address="广州市天河区xxx路50号",
        tracking_number=None,
        placed_at="2025-08-20T09:00:00",
    ),
    Order(
        order_id="ord_012",
        customer_id="cust_003",
        status=OrderStatus.DELIVERED,
        items=[{"name": "屏幕贴膜", "quantity": 1, "price": 59.00}],
        total_amount=59.00,
        currency="CNY",
        shipping_address="广州市天河区xxx路50号",
        tracking_number="ZTO7788990011",
        placed_at="2025-07-05T13:00:00",
        shipped_at="2025-07-06T11:00:00",
        delivered_at="2025-07-08T10:00:00",
    ),
    # --- 高金额订单（≥500 元，触发 Supervisor HITL 人工审核） ---
    Order(
        order_id="ord_013",
        customer_id="cust_004",
        status=OrderStatus.PROCESSING,
        items=[{"name": "高端游戏主机", "quantity": 1, "price": 8999.00}],
        total_amount=8999.00,
        currency="CNY",
        shipping_address="深圳市南山区xxx路88号",
        tracking_number=None,
        placed_at="2025-09-05T10:00:00",
    ),
    Order(
        order_id="ord_014",
        customer_id="cust_004",
        status=OrderStatus.SHIPPED,
        items=[{"name": "4K 投影仪", "quantity": 1, "price": 4599.00}],
        total_amount=4599.00,
        currency="CNY",
        shipping_address="深圳市南山区xxx路88号",
        tracking_number="SF5566778899",
        placed_at="2025-08-28T15:00:00",
        shipped_at="2025-08-29T10:00:00",
    ),
    Order(
        order_id="ord_015",
        customer_id="cust_005",
        status=OrderStatus.DELIVERED,
        items=[{"name": "人体工学椅", "quantity": 1, "price": 2299.00}],
        total_amount=2299.00,
        currency="CNY",
        shipping_address="杭州市西湖区xxx路66号",
        tracking_number="JD9090909090",
        placed_at="2025-07-20T14:00:00",
        shipped_at="2025-07-21T10:00:00",
        delivered_at="2025-07-24T16:00:00",
    ),
    Order(
        order_id="ord_016",
        customer_id="cust_005",
        status=OrderStatus.REFUNDED,
        items=[{"name": "机械键盘 V2", "quantity": 1, "price": 699.00}],
        total_amount=699.00,
        currency="CNY",
        shipping_address="杭州市西湖区xxx路66号",
        tracking_number="YT1122334455",
        placed_at="2025-08-10T11:00:00",
        shipped_at="2025-08-11T09:00:00",
        delivered_at="2025-08-13T10:00:00",
    ),
    Order(
        order_id="ord_017",
        customer_id="cust_006",
        status=OrderStatus.PENDING,
        items=[{"name": "便携音箱", "quantity": 1, "price": 199.00}],
        total_amount=199.00,
        currency="CNY",
        shipping_address="成都市武侯区xxx路30号",
        tracking_number=None,
        placed_at="2025-09-08T09:00:00",
    ),
    Order(
        order_id="ord_018",
        customer_id="cust_006",
        status=OrderStatus.CANCELLED,
        items=[{"name": "耳机收纳包", "quantity": 1, "price": 49.00}],
        total_amount=49.00,
        currency="CNY",
        shipping_address="成都市武侯区xxx路30号",
        tracking_number=None,
        placed_at="2025-08-01T10:00:00",
    ),
]
