...
class OpenAIProvider(LLMProvider):
    ...
    async def chat_structured(
        ...
        **kwargs,
        ...
        msgs = list(messages)
        DashScopeProvider._inject_format_guide(msgs, schema)
...
# 跨 Provider 引用 DashScope 的静态方法（避免重复代码）
from src.llm.dashscope_provider import DashScopeProvider  # noqa: E402
